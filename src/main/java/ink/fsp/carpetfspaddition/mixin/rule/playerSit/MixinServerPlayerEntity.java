package ink.fsp.carpetfspaddition.mixin.rule.playerSit;

import ink.fsp.carpetfspaddition.FspSettings;
import ink.fsp.carpetfspaddition.utils.rule.playerSit.SitEntity;
...
public abstract class MixinServerPlayerEntity extends PlayerEntity {
    ...
    public void setSneaking(boolean sneaking) {
        if (!FspSettings.playerSit || (sneaking && this.isSneaking())) {
...
//                this.networkHandler.sendPacket(new EntityTrackerUpdateS2CPacket(this.getId(), this.getDataTracker(), true));  // 1.19
            }
        }
    }
